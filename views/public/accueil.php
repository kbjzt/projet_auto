  ...
  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="./assets/images/Audi-TTRS-2016.jpeg" class="d-block w-100 " style="height:400px" alt="...">
      </div>
      <div class="carousel-item">
        <img src="./assets/images/audi.jpeg" class="d-block w-100" style="height:400px" alt="...">
      </div>
      <div class="carousel-item">
        <img src="./assets/images/bmws2.jpg" class="d-block w-100" style="height:400px" alt="...">
      </div>
    </div>
        ...
        <?php foreach ($cars as $car) { ?>
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"> <?= strtoupper($car->getCategorie()->getNom_Cat()); ?>: <?= $car->getMarque() ?></h5>
                ...
                <ul class="list-group">
                  ...
                  <?php } ?>
                    ...
                    <strong class="badge rounded-pill">
                      <?php if ($car->getQuantite() == 0) { ?>
                        <a href="index.php?action=order&id=<?= $car->getId_v(); ?>" class="btn btn-warning btn-sm">
                          Commander
                        </a>
                      <?php } ?>
      ...
      <ul class="list-group list-group-flush">
        <?php foreach ($tabCat as $cat) { ?>
          ...
          <li class="list-group-item">
            <a href="index.php?id=<?= $cat->getId_cat(); ?>"><?= ucfirst($cat->getNom_cat()); ?></a>
          </li>
