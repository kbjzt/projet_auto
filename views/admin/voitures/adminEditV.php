...
<div class="container">
    <div class="row">
        <div class="col-8 offset-2">
            <h1 class="display-6 text-center font-monospace text-decoration-underline">Editer la voiture N° <?= $editCar->getId_v(); ?> </h1>
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <select id="cat" name="cat" class="form-select">
                            ...
                            ?>
                            <?= $editCar->getCategorie()->getNom_cat(); ?>
                            </option>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <img src="./assets/images/<?= $editCar->getImage(); ?>" alt="" width="100" class="img-thumbnail mt-2">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
