    ...
    <div class="row">
        <div class="col-6 offset-3">
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <input type="text" name="loginEmail" id="loginEmail" class="form-control" placeholder="Entrez un login ou un email">

                <label for="pass">Mot de passe*</label>
                <input type="password" name="pass" id="pass" class="form-control" placeholder="Entrez un mot de passe">
